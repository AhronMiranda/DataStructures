...
public class BandData {
    ...
    public void runBandDataExtractionAndDisplay() {
        ...
        try {
            ...
            while (FR.hasNextLine()) {
                ...
                if (!FR.hasNextInt())
                    break;
                aPerfID[ctr] = FR.nextInt();
                FR.nextLine();
                if (!FR.hasNextDouble())
                    break;
                aStagePrice[ctr] = FR.nextDouble();
                FR.nextLine();
                if (!FR.hasNextInt())
                    break;
                aViewers[ctr] = FR.nextInt();
                FR.nextLine();
                ctr++;
            }
            ...
            for (int a = 0; a < ctr; a++) {
                System.out.printf(
                        "%-2d | Stage Name: %-20s | Genres: %-20s | PERFORMANCE ID: %3d | Average Price: $ %-15.2f | Average Viewers: %-10d\n",
    ...
    public void runAddBandData() {
        ...
        try {
            ...
            do {
                ...
                aNames[ctr] = inputString();
                System.out.print("Genre: ");
                aGenre[ctr] = inputString();
                System.out.print("Performance ID: ");
                aPerfID[ctr] = inputInt();
                System.out.print("Stage Price: ");
                aStagePrice[ctr] = inputDouble();
                System.out.print("Average Viewers: ");
                aViewers[ctr] = inputInt();
    ...
    public void runSearchBandData() {
        try {
            ...
            int a = inputInt() - 1;
            System.out.printf(
                    "%-2d | Stage Name: %-20s | Genres: %-20s | PERFORMANCE ID: %2d | Average Price: $ %-15.2f | Average Viewers: %-10d\n",
                    a + 1, aNames[a], aGenre[a], aPerfID[a], aStagePrice[a], aViewers[a]);
    ...
    public void runEditBandData() {
        try {
            ...
            if (cAnsw == 'y' || cAnsw == 'Y') {
                System.out.print("Name: ");
                aNames[a] = inputString();
                System.out.print("Genre: ");
                aGenre[a] = inputString();
                System.out.print("Performance ID: ");
                aPerfID[a] = inputInt();
                System.out.print("Stage Price: ");
                aStagePrice[a] = inputDouble();
                System.out.print("Average Viewers: ");
                aViewers[a] = inputInt();
        ...
        try {
            ...
            if (cAnsw == 'y' || cAnsw == 'Y') {
                ...
                for (int i = 0; i < ctr; i++) {
                    if (aNames[i] == null) {
                        continue;
                    } // skips round once deleted part is skipped so it wont write
